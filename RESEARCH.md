# BirdFlowMetal research reference

This is the detailed companion to the visual [README](README.md). It preserves
the project's full methods, validation record, command reference, source
provenance, and scientific boundaries. Media on the README is a navigational
showcase; the evidence and qualification context live here and in the linked
records.
...
shoulder, flank, or tail discontinuity. An additional low-side takeoff gate at
yaw/pitch `(1.55, -0.30)` and `0.60 m` keeps the exact five-frame enclosed-hole,
largest-component, active-identity, and full-coverage counts of the CPU-rachis
predecessor. Beauty SSIM is at least `0.999853`; at most `394 / 360,000` pixels
